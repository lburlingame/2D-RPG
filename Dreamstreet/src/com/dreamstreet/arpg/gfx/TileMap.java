                ...
                for (String val : values) {
                    if (!val.isEmpty()) {
                        ...
                        if (id == 0) {
                            ...
                            tiles[rows][columns] = new Tile(64,47,7, true);
                        }else if(id == 8){
                            tiles[rows][columns] = new Tile(64,47,8, true);
                        }else if(id > 99){
        ...
        for(int y = 0; y < tiles.length; y++) {
            for (int x = 0; x < tiles[y].length; x++) {
                if (tiles[y][x] != null) {
                    ...
                    g.drawImage(Textures.getTile(tiles[y][x].id),(int)((curr.x-xOffset)*scale +.49),(int)((curr.y-yOffset)*scale+.49),(int)(tiles[y][x].width*scale+.49),(int)(tiles[y][x].height*scale+.49),null);
